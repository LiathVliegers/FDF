...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/03 16:00:31 by livliege          #+#    #+#             */
/*   Updated: 2024/04/03 16:03:16 by livliege         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 		{
// 			if ((y + 1) < map->height)
// 				menu_line(map->points[y][x], map->points[y + 1][x], map);
// 			if (map->points[y][x].last_point == 0)
// 				menu_line(map->points[y][x], map->points[y][x + 1], map);
// 			if (map->points[y][x].last_point == 1)
// 				break ;
// 			x++;
// 		}
